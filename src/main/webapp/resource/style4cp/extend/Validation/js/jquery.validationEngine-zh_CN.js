(function($){
//	var ajaxURL = "http://localhost:8080/wz";
//	alert($("#fkpath").attr("val"));
//	var ajaxURL = "http://wx.weizhen.tmsps.com";
	var ajaxURL = $("#fkpath").attr("val");
	// 验证规则
		...
		newLang:function(){
			$.validationEngineLanguage.allRules = {
				...
				"price":{
					...
					"alertText" : "* 价格必须为正的数字，保留两位小数"
				},
				//验证商家账号
				"checkMerchantsUser": {
			 		"url": ajaxURL+"/checkMerchantsUser.htm",
					"extraDataDynamic" : [ '#m_id' ],
					//"alertTextOk": "* 此帐号名称可以使用",
					"alertText": "* 此手机号码已被其他人使用",
			 		"alertTextLoad": "* 正在确认手机号码是否有其他人使用，请稍等。"
			 	},
				//验证商家昵称
				"checkMerchantsNickUser": {
			 		"url": ajaxURL+"/checkMerchantsNickUser.htm",
					"extraDataDynamic" : [ '#m_id' ],
					//"alertTextOk": "* 此帐号名称可以使用",
