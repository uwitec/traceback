...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${path}/resource/rqq/css/inquiry-detial-pc.css">
</head>
<body>
<div class="main-img">
    <img src="${path}/resource/rqq/img/bg1.jpg" class="bg-img">
    <div class="main">
<div class="header">
    <img src="${path}/resource/rqq/img/banner1.jpg" class="img-ban"/>
    <div class="logo1">
        <div class="logo">
            <img src="${path}/img/${shop.logo_file_id }.htm" class="logo-img"/>
        </div>
