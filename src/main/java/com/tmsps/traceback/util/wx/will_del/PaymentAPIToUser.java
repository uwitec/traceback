 ...
 *
 */
public class PaymentAPIToUser extends BaseAPI {
	public PaymentAPIToUser(WxConfig config) {
		super(config);
	}

	// 文档地址：https://pay.weixin.qq.com/wiki/doc/api/tools/mch_pay.php?chapter=14_2
	private static String WXPAYURL = "https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers";
	...
	public Map<String, String> payToUser(String apiclient_cert_p12_path, Map<String, String> params) {
		...
		try {
			...
			params.put("mchid", config.getMch_id());
