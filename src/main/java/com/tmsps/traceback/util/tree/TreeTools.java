...
public class TreeTools {
	...
	public static List<Map<String, Object>> handleTree(List<Map<String, Object>> menuList, boolean isChecked) {
		for (Map<String, Object> map : menuList) {
			...
			map.put("text", map.get("code")+":>"+map.remove("name"));
			map.put("leaf", true);
			if (isChecked) {
	...
	// 预处理树节点
		public static List<Map<String, Object>> handleAreaTree(List<Map<String, Object>> menuList, boolean isChecked,int deep) {
			for (Map<String, Object> map : menuList) {
